...
CREATE PROCEDURE IF NOT EXISTS rewards_report (
...
CREATE PROCEDURE IF NOT EXISTS film_in_stock(IN p_film_id INT, IN p_store_id INT, OUT p_film_count INT)
READS SQL DATA
BEGIN
     SELECT inventory_id
     FROM inventory
...
CREATE PROCEDURE IF NOT EXISTS film_not_in_stock(IN p_film_id INT, IN p_store_id INT, OUT p_film_count INT)
READS SQL DATA
BEGIN
     SELECT inventory_id
     FROM inventory
